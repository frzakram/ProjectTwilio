...
public class ChatActivity extends AppCompatActivity {
    ...
    */
    final static String SERVER_TOKEN_URL = "https://liver-manatee-3514.twil.io/chat-token";
   ...
   // private String mIdentity = "hamza";
    private String mIdentity = "faraz";
                    ...
                    public void onCompleted(Exception e, JsonObject result) {
                        if (e == null) {
                            ...
                            Toast.makeText(ChatActivity.this,
                                    "Error from access token", Toast.LENGTH_SHORT)
                                    .show();
                        }
                    }
                });
    ...
    private void loadChannels() {
        ...
        mChatClient.getChannels().getPublicChannelsList(new CallbackListener<Paginator<ChannelDescriptor>>() {
            ...
            public void onSuccess(Paginator<ChannelDescriptor> channelDescriptorPaginator) {
                ...
                ChannelDescriptor channelDescriptor = channelDescriptorPaginator.getItems().get(0);

                     mChatClient.getChannels().getChannel(channelDescriptor.getSid(), new CallbackListener<Channel>() {
            @Override
